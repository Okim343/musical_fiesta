...
Open the entire directory in VS Code. Search for `musical_fiesta` in the entire
codebase and replace it with `new_project_name`, i.e., a concise version of your
project's name (often called a "slug"). Rename the folder `src/musical_fiesta` to
